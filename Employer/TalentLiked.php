...
<html lang="en">
  ...
  <div class="site-wrap">
            ...
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
				...
				<li class="has-children">
                  ...
                  <ul class="dropdown">
                    <li><a href="index.php#talentsearch-section" class="nav-link">Search</a></li>
                    <li><a href="#talentliked-section" class="nav-link">Liked</a></li>                   
                    </li>
                  </ul>
                </li>             
    ...
    <div class="site-blocks-cover overlay" style="background-image: url(images/home.jpeg);" data-aos="fade" id="home-section">
      ...
      <a href="#talentliked-section" class="mouse smoothscroll">
	...
	<section class="site-section border-bottom bg-white" id="talentliked-section">    
      <div class="container">
        <div class="row mb-5">
          <div class="col-12 text-center" data-aos="fade">
            <h2 class="section-title mb-3">Talent Liked</h2>
          </div>
        </div>
        <div class="row">
                      <?php
...
$sql = "SELECT talent.TalentId, talent.StudentName, talent.TalentTitle, talent.IG, talent.TalentVideo, talent.TalentResume, talent.Description, like_master.TalentId, like_master.EmployerId
FROM talent, like_master
WHERE like_master.TalentId=talent.TalentId and like_master.EmployerId='".$_SESSION['ID']."'";
// Execute query
...
?>
		<table class="bg-light" width="100%" border="1" cellpadding="1" cellspacing="2" bordercolor="#1CB5F1" >
			<table class="bg-light" width="100%" border="15" cellspacing="5" cellpadding="2" bordercolor="#1CB5F1">
				<tr>
					<td><strong>Student Name</strong></td>
					<td class="style3"><div align="left" class="style9 style5"><?php echo $StudentName;?></div></td>
				</tr>
				<tr>
					<td><strong>Talent Title</strong></th>
					<td class="style3"><div align="left" class="style9 style5"><?php echo $TalentTitle;?></div></td>
				</tr>
					<td><strong>IG</strong></th>
					<td class="style3"><div align="left" class="style9 style5"><?php echo $IG;?></div></td>						
				<tr>
				</tr>
					<td><strong>Video</strong></th>
					<td class="style3"><div align="left" class="style9 style5"><?php echo $TalentVideo;?></div></td>
				<tr>
				</tr>
				<tr>
					<td><strong>Resume</strong></th>
					<td class="style3"><div align="left" class="style9 style5"><?php echo $TalentResume;?></div></td>
				</tr>
				<tr>
